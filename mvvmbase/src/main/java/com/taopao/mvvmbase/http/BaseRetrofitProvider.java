...
public class BaseRetrofitProvider {
    ...
    private static class SingletonHolder {
        private static BaseRetrofitProvider INSTANCE = new BaseRetrofitProvider();
    }
    ...
    private BaseRetrofitProvider(String url) {
        this(url, null);
    }

    private BaseRetrofitProvider(String url, Map<String, String> headers) {
