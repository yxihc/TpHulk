...
import com.taopao.tphulk.mvvmdemo.DemoMvvmActivity;
...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBind.btnDemomvvm.setOnClickListener(view1 -> startActivity(new Intent(getActivity(), DemoMvvmActivity.class)) );
    }
}
